...
from NLP.bert_intent_slot.datasets import IntentSlotDataset
from NLP.bert_intent_slot.models import JointBert
from NLP.bert_intent_slot.tools import save_module, split_data
...
def main():
    ...
    # data parameters
    data_root = r'src\NLP\bert_intent_slot\data'
    parser.add_argument("--train_data_path", type=str, default=os.path.join(data_root, 'DouBanTop250/data.json'), help="training data path")
    parser.add_argument("--train_val_data_split", type=float, default=0.8, help="training data and val data split rate")
    parser.add_argument("--slot_label_path", type=str, default=os.path.join(data_root, 'DouBanTop250/slot_labels.txt'), help="slot label path")
    parser.add_argument("--intent_label_path", type=str, default=os.path.join(data_root, 'DouBanTop250/intent_labels.txt'), help="intent label path")
    ...
    parser.add_argument("--train_epochs", type=int, default=3, help='training epoch number')
